...
os.environ.setdefault(
    "WEBHOOK_SECRET",
    "test-only-webhook-secret-not-for-real-use-0123456789abcdef",
)
os.environ.setdefault(
    "RAZORPAY_WEBHOOK_SECRET",
    "test-only-razorpay-secret-not-for-real-use-0123456789abcdef",
)
os.environ.setdefault(
    "MANDATE_RESCUE_API_KEY",
    "test-only-api-key-0123456789abcdef",
)
